...
# 看完了吗？你现在不会在想「商业面前利益最重要」、「平台利益至上」、「酷安是我的私有财产」一类的话，然后想到这里再告诉自己其实做得并没有错吧？那再退一步讲，这个模块断了你的财路了吗？去除了信息流广告吗？这个模块没有给你带来用户体验上一些改进的灵感？我帮你改进用户体验你还撤我认证？你难道觉得维持现在平台的状况，不加自定义水印，不支持 Markdown，不加临时关闭水印，不给用户更多的隐私权，用着全世界最「顶级」的折叠系统、就靠现在的流量、知名用户和广告来恰烂钱就足够了吗？
# 如果你觉得足够了，**我无语**。
# 如果你觉得因为你们现在是个小公司，才会采取和 QQ 对待 QN 等模块不一样的做法，建议从上方「难怪你们平台做不大」读起。
